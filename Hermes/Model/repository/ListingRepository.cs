...
namespace Hermes.Model
{
    class ListingRepository
    {
        ...
        public void DeleteFromFavorite(Favourite favourite)
        {
            if (Singleton.GetInstance().OpenConnection() == true)
            {
        ...
        public void DeleteAllFromFavorite(Favourite favourite)
        {
            if (Singleton.GetInstance().OpenConnection() == true)
            {
        ...
        private void DeleteFromHistory(int listingId, int userId)
        {
            if (Singleton.GetInstance().OpenConnection() == true)
            {
        ...
        public void DeleteFromHistory(int userId)
        {
            if (Singleton.GetInstance().OpenConnection() == true)
            {
